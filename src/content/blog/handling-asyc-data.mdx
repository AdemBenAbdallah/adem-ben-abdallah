...
<figure>
  <Image src="/static/race_cond1.png" alt="race condition 1" />
  <figcaption>
...
<figure>
  <Image src="/static/race_cond2.png" alt="race condition 2" />
  <figcaption>
...
<figure>
  <Image src="/static/race_cond3.png" alt="race condition 3" />
  <figcaption>The data for ID 2 returns first.</figcaption>
</figure>
<figure>
  <Image src="/static/race_cond4.png" alt="race condition 4" />
