          ...
          <div className="flex flex-col items-center justify-center py-20 h-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
              <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                I&apos;m Adem, I enjoy building sites & apps.
              </h1>
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                I&apos;m a former Quetratech engineer, now working as a
                freelancer and running my own blog.
              </p>
              ...
              <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                ...
                >
                  <p className="text-foreground text-sm text-center md:text-base font-medium px-4 lg:px-0">
                    ☝️ Start bringing your dream website to life!
                  </p>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
              Unlock My Robust Features
            </h2>
            <p className="text-muted-foreground mt-6">
              Explore a comprehensive suite of features designed to help you
              create exceptional SaaS applications and modern landing pages
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Discover how businesses of all sizes benefit from these services.
              Hear from real people sharing their experiences.
            </p>
          </div>
        </Container>
        <Container>
          ...
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              ...
              <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                Elevate your digital presence with Adem, a skilled full-stack
                developer.
              </p>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 rounded-lg lg:rounded-2xl border border-border/80 py-4 md:py-8">
              <div className="flex flex-col items-start gap-4 w-full">
                ...
                <p className="text-base text-muted-foreground">
                  Stay informed with the latest updates, tips, and exclusive
                  content.
                </p>
              </div>
